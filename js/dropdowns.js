...
let tabIngredients = [], tabAppareils = [], tabUstentiles = [], arrayOfFilteredRecipes = [], tabSelectedContainer = [], sumIngr = 0, sumUst = 0, isFinalArrayEmptyButNotOneOfTheFiltersArrays = false;
